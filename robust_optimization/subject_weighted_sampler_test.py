...
class SubjectWeightedSamplerTest(NiftyNetTestCase):
    def test_3d_concentric_init(self):
        sampler = SubjectWeightedSampler(reader=get_concentric_window_reader(),
    ...
    def test_3d_init(self):
        sampler = SubjectWeightedSampler(reader=get_3d_reader(),
    ...
    def test_2d_init(self):
        sampler = SubjectWeightedSampler(reader=get_2d_reader(),
    ...
    def test_dynamic_init(self):
        sampler = SubjectWeightedSampler(reader=get_dynamic_window_reader(),
...
class SubjectWeightedSamplingTest(NiftyNetTestCase):
    def test_uniform_distribution_as_default(self):
        pass
